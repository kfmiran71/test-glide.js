...
test("timestamp selection uses arrival time for intermediate passenger stops", () => {
  ...
  const stopUpdates = [
    {
      arrival: { time: feedTimestamp + 120 },
      departure: { time: feedTimestamp + 150 },
      stopId: "248S",
      stopSequence: 20
    },
    {
  ...
  const evidence = buildGtfsEvidence([
    {
      tripUpdate: {
        trip: {
          routeId: "4",
          startDate: "20260804",
          tripId: "crown-heights-4-downtown"
        },
        stopTimeUpdate: [
          {
            arrival: { time: feedTimestamp + 120 },
...
test("origin departure keeps departure time when origin is conclusive", () => {
  ...
  const stopUpdates = [
    {
      arrival: { time: feedTimestamp },
      departure: { time: feedTimestamp + 300 },
      stopId: "257N",
      stopSequence: 1
    },
    {
      arrival: { time: feedTimestamp + 420 },
      departure: { time: feedTimestamp + 450 },
      stopId: "256N",
      stopSequence: 2
    }
  ];
...
test("terminal arrival and ambiguous partial updates prefer arrival time", () => {
  ...
  const terminalUpdates = [
    {
      arrival: { time: feedTimestamp + 60 },
      departure: { time: feedTimestamp + 90 },
      stopId: "701N",
      stopSequence: 15
    },
    {
  ...
  const terminalRole = classifyTargetServiceRole(
    terminalUpdates,
    "702N",
    terminalUpdates[1]
  );
  const terminalSelection = selectRiderFacingStopTime(
    terminalUpdates[1],
    terminalRole
  );
